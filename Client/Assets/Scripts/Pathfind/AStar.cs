...
public class AStar
{
    ...
    *@param _pesoHoriz, int que define el costo de moverse horizontalmente 
    *@param _matriz, float[,] array de dos dimensiones que representa el tablero de juego
    *@param _nHeight, int cantidad de filas del tablero
    *@param _nWidth, int cantidad de columnas en el tablero
    */
    ...
    */
    ...
    /*!
     *@brief Devuelve la cantidad de nodos entre el puntode inicio y el punto meta 
     *@retrun int 
    */
